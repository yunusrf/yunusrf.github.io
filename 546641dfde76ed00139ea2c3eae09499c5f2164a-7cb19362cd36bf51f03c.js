/*! For license information please see 546641dfde76ed00139ea2c3eae09499c5f2164a-7cb19362cd36bf51f03c.js.LICENSE.txt */
    ...
    2468: function (e, t, n) {
      ...
      function E(e) {
        ...
        if (g.generated || k.generated.initial) {
          ...
          C.generated = {
            delayed: C.property + ': ' + L.delayed + ';',
            instant: C.property + ': ' + L.instant + ';',
          };
      ...
      function N(e, t) {
        ...
        return t.reveal || a ? O.call(this, e, r) : t.reset || i ? M.call(this, e) : void 0;
      }
      function O(e, t) {
        var n = [
      ...
      function F(e, t, n) {
        ...
        try {
          ...
          return b.call(this, 'Reveal failed.', d.message);
        }
        x(o, function (e) {
          ...
          !0 !== n &&
            ...
            (this.initTimeout = window.setTimeout(z.bind(this), 0)));
      }
      function B() {
        var e = this;
      ...
      var r,
        ...
        re = function (e, t) {
          var n = e.baseTag,
            ...
            u = e.title,
            m = e.titleAttributes;
          oe(b.BODY, r), oe(b.HTML, a), ie(u, m);
          var p = {
              baseTag: le(b.BASE, n),
        ...
        ue = function (e) {
          ...
          return {
            ...
            script: de(b.SCRIPT, s, r),
            style: de(b.STYLE, c, r),
            title: de(b.TITLE, { title: u, titleAttributes: m }, r),
          };
        },
        me = d()(
          function (e) {
            return {
              ...
              metaTags: Q(b.META, [T, y, k, A, C], e),
              noscriptTags: Q(b.NOSCRIPT, [S], e),
              onChangeClientState: $(e),
              scriptTags: Q(b.SCRIPT, [L, S], e),
    ...
    7952: function (e, t, n) {
      ...
      const l = e => {
        ...
        const { pathname: s } = (0, i.useLocation)(),
          ...
          h = { title: t || d, description: n || u, image: `${m}${l || p}`, url: `${m}${s}` };
        return r.createElement(
          a.m,
          { title: t, defaultTitle: h.title, titleTemplate: `%s | ${d}` },
      ...
      var j = e => {
              ...
              r.createElement(
                ...
                r.createElement(
                  ...
                  r.createElement(
                    ...
                    i && a
                      ? r.createElement(_e, { finishLoading: () => o(!1) })
                      : r.createElement(
                          A,
                          null,
                          ...
                          r.createElement('div', { id: 'content' }, t, r.createElement(ot, null)),
                        ),
                  ),
                ),
              ),
        ...
        z = { duration: 1e3, delay: 0, endDelay: 0, easing: 'easeOutElastic(1, .5)', round: 0 },
        N = [
          'translateX',
          'translateY',
          'translateZ',
      ...
      var _ = {
        ...
        key: function (e) {
          return (
            !L.hasOwnProperty(e) && !z.hasOwnProperty(e) && 'targets' !== e && 'keyframes' !== e
          );
        },
      };
      function D(e) {
      ...
      function R(e, t) {
        var n = D(e),
          r = M(_.und(n[0]) ? 1 : n[0], 0.1, 100),
          a = M(_.und(n[1]) ? 100 : n[1], 0.1, 100),
          i = M(_.und(n[2]) ? 10 : n[2], 0.1, 100),
          o = M(_.und(n[3]) ? 0 : n[3], 0.1, 100),
          l = Math.sqrt(a / r),
          s = i / (2 * Math.sqrt(a * r)),
      ...
      function ie(e, t) {
        return _.dom(e) && !_.inp(e) && (!_.nil(ne(e, t)) || (_.svg(e) && e[t]))
          ? 'attribute'
          : _.dom(e) && Q(N, t)
          ? 'transform'
      ...
      function ve(e) {
        return $(e ? G(_.arr(e) ? e.map(U) : U(e)) : [], function (e, t, n) {
      ...
      function be(e, t) {
        var n = X(t);
        if ((/^spring/.test(n.easing) && (n.duration = R(n.easing)), _.arr(e))) {
          var r = e.length;
          2 === r && !_.obj(e[0])
            ? (e = { value: e })
        ...
        return a
          .map(function (e, n) {
            var r = _.obj(e) && !_.pth(e) ? e : { value: e };
            return (
              _.und(r.delay) && (r.delay = n ? 0 : t.delay),
              _.und(r.endDelay) && (r.endDelay = n === a.length - 1 ? t.endDelay : 0),
              r
            );
          })
          .map(function (e) {
      ...
      function ye(e, t) {
                ...
                var t = $(
                  ...
                  r = function (r) {
                    ...
                    n[a] = e.map(function (e) {
                      var t = {};
                      for (var n in e) _.key(n) ? n == a && (t.value = e[n]) : (t[n] = e[n]);
                      return t;
                    });
                  },
                  a = 0;
        ...
        t))
          _.key(a) && n.push({ name: a, tweens: be(t[a], e) });
        return n;
      }
      function we(e, t) {
        var n;
        return e.tweens.map(function (r) {
          ...
          return (
            ...
            (a.isPath = _.pth(i)),
            (a.isPathTargetInsideSVG = a.isPath && _.svg(t.target)),
            (a.isColor = _.col(a.from.original)),
            a.isColor && (a.round = 1),
            (n = a),
            a
          );
      ...
      var Ae = [],
        je = (function () {
          ...
          return (
            ...
            function () {
              e ||
                (Le() && ze.suspendWhenDocumentHidden) ||
                !(Ae.length > 0) ||
      ...
      function ze(e) {
        ...
        function u() {
          (n = 0), (r = d(s.currentTime) * (1 / ze.speed));
        }
        function m(e, t) {
        ...
        function p(e) {
          for (var t = 0, n = s.animations, r = n.length; t < r; ) {
            ...
            for (
              var d = M(e - c.start - c.delay, 0, c.duration) / c.duration,
              ...
              (x = c.isPath ? he(c.value, u * b, c.isPathTargetInsideSVG) : y + u * (b - y)),
            ...
            Ee[a.type](i.target, a.property, g, i.transforms), (a.currentValue = g), t++;
          }
        }
        function f(e) {
        ...
        return (
          ...
          (s.play = function () {
            s.paused && (s.completed && s.reset(), (s.paused = !1), Ae.push(s), u(), je());
          }),
          (s.reverse = function () {
      ...
      (ze.version = '3.2.1'),
        (ze.speed = 1),
        (ze.suspendWhenDocumentHidden = !0),
        (ze.running = Ae),
        ...
        (ze.set = ke),
        (ze.convertPx = re),
        (ze.path = function (e, t) {
          var n = _.str(e) ? V(e)[0] : e,
            r = t || 100;
          return function (e) {
            return { property: e, el: n, svg: fe(n), totalLength: pe(n) * (r / 100) };
          };
        }),
        (ze.setDashoffset = function (e) {
          var t = pe(e);
          return e.setAttribute('stroke-dasharray', t), t;
        }),
        (ze.stagger = function (e, t) {
          void 0 === t && (t = {});
          ...
          return function (e, t, v) {
            ...
            return f + (d ? (m - u) / g : u) * (Math.round(100 * h[t]) / 100) + p;
          };
        }),
        (ze.timeline = function (e) {
          void 0 === e && (e = {});
          var t = ze(e);
          return (
            (t.duration = 0),
            (t.add = function (n, r) {
              ...
              (s.autoplay = !1),
                ...
                (s.timelineOffset = _.und(r) ? c : ce(r, c)),
                o(t),
            ...
            r.createElement(
              ...
              c
                ? r.createElement(
                    ...
                    r.createElement(Ye, null, r.createElement(dt, null)),
            ...
            r.createElement(
              ...
              r.createElement(
                ...
                r.createElement(
                  'div',
                  null,
                  'Designed & Built by Brittany Chiang Revised by Yunus Parvej',
                ),
                e.stars &&
                  e.forks &&
                  r.createElement(
      ...
      const lt = c.default.button.withConfig({
      ...
      var dt = () => {
        ...
        return r.createElement(
          ...
          e ? r.createElement(st, null) : r.createElement(ct, null),
        );
      };
      ...
      var mt = () => {
          ...
          const a = [
            ...
            r.createElement(
              ...
              'Ph.D | Application Software Development Professional | Technical Architect | Software Consultant | Machine Learning Scientist',
            ),
            r.createElement(
              r.Fragment,
              null,
              r.createElement(
                ...
                r.createElement(
                  'p',
                  null,
                  'With over 20 years of experience in software architecture and development, I have led and delivered innovative solutions across mobile, desktop, and backend platforms. My expertise spans system software, native mobile apps, and data-driven technologies, including machine learning and predictive analytics.',
                ),
                r.createElement(
                  'p',
                  null,
                  'As a collaborative leader and mentor, I thrive on solving complex challenges and continuously advancing my technical skill set, from hands-on coding to creating technical documentation.',
                ),
              ),
            ),
          ];
      ...
      var xt = () => {
        const e = (0, r.useRef)(null),
          t = (0, T.jt)();
        (0, r.useEffect)(() => {
          t || ft.A.reveal(e.current, (0, Fe.srConfig)());
        }, []);
        const a = ['JavaScript (ES6+)', 'TypeScript', 'React', 'Eleventy', 'Node.js', 'WordPress'];
        return r.createElement(
          ht,
          { id: 'about', ref: e },
      ...
      const bt = c.default.section.withConfig({
        ...
        wt = c.default.button.withConfig({
      ...
      var Ct = () => {
        const e = (0, o.useStaticQuery)('2009693873').jobs.edges,
          ...
          c = (0, T.jt)();
        (0, r.useEffect)(() => {
          c || ft.A.reveal(s.current, (0, Fe.srConfig)());
        }, []);
        (0, r.useEffect)(() => {
          l.current[a]
            ? l.current[a].focus()
        ...
        return r.createElement(
          ...
          r.createElement(
            ...
            r.createElement(
              ...
              r.createElement(Et, { activeTabId: t }),
            ),
            r.createElement(
              kt,
              null,
      ...
      const Tt = c.default.ul.withConfig({
      ...
      var jt = () => {
        ...
        return (
          (0, r.useEffect)(() => {
            a ||
              (ft.A.reveal(t.current, (0, Fe.srConfig)()),
              n.current.forEach((e, t) => ft.A.reveal(e, (0, Fe.srConfig)(100 * t))));
          }, []),
          r.createElement(
            'section',
            { id: 'projects' },
                  ...
                  return r.createElement(
                    ...
                    r.createElement(
                      ...
                      r.createElement(
                        'a',
                        { href: l || d || '#' },
                        r.createElement(pt.G, { image: m, alt: s, className: 'img' }),
                      ),
                    ),
                  );
                }),
      ...
      const Lt = c.default.section.withConfig({
      ...
      var Ot = () => {
        ...
        (0, r.useEffect)(() => {
          m ||
            (ft.A.reveal(c.current, (0, Fe.srConfig)()),
            ft.A.reveal(d.current, (0, Fe.srConfig)()),
            u.current.forEach((e, t) => ft.A.reveal(e, (0, Fe.srConfig)(100 * t))));
        }, []),
          (0, r.useEffect)(() => {
            const e = e => {
              'Escape' === e.key && p();
            ...
            m
              ? r.createElement(
                  ...
                  g &&
                    g.map((e, t) => {
                      let { node: n } = e;
                      return r.createElement(zt, { key: t }, v(n));
                    }),
                )
              : r.createElement(
                  De.A,
...
//# sourceMappingURL=546641dfde76ed00139ea2c3eae09499c5f2164a-7cb19362cd36bf51f03c.js.map
