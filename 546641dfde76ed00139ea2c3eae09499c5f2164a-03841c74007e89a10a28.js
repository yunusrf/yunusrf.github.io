/*! For license information please see 546641dfde76ed00139ea2c3eae09499c5f2164a-03841c74007e89a10a28.js.LICENSE.txt */
  ...
  [559],
  {
    ...
    2532: function (e, t, n) {
      ...
      const C = [
        ...
        A = { image: i().object.isRequired, alt: L },
        j = [
          'as',
          'image',
          'style',
                ...
                O.then(e => {
                  ...
                  C.current &&
                    ((C.current.innerHTML = n(
                      o({ isLoading: !0, isLoaded: z.has(S), image: a }, g),
                    )),
                    z.has(S) ||
                      (t = requestAnimationFrame(() => {
                        C.current && (r = l(C.current, S, z, i, p, f, h));
                      })));
                }),
                () => {
            ...
            (0, r.useLayoutEffect)(() => {
              z.has(S) &&
                ...
                ((C.current.innerHTML = I(
                  o({ isLoading: z.has(S), isLoaded: z.has(S), image: a }, g),
                )),
                null == p || p({ wasCached: !0 }),
                null == f || f({ wasCached: !0 }));
            }, [a]),
      ...
      const D = _(function (e) {
          ...
          a && (n = a), (f = o({ objectFit: v, objectPosition: b, backgroundColor: g }, f));
          const {
              width: x,
              height: w,
              layout: L,
          ...
          return (
            A.fallback &&
              (P.fallback = o({}, A.fallback, {
                srcSet: A.fallback.srcSet ? T(A.fallback.srcSet) : void 0,
              })),
            A.sources && (P.sources = A.sources.map(e => o({}, e, { srcSet: T(e.srcSet) }))),
            r.createElement(
              t,
              o({}, M, {
                style: o({}, O, i, { backgroundColor: g }),
                className: `${I}${n ? ` ${n}` : ''}`,
              }),
              r.createElement(
                h,
                { layout: L, width: x, height: w },
                r.createElement(E, o({}, m(j, !1, L, x, w, N, v, b))),
                r.createElement(
                  k,
                  o(
    ...
    7337: function (e, t, n) {
      ...
      function pe(e) {
        ...
        switch (e.tagName.toLowerCase()) {
          ...
          case 'line':
            return (function (e) {
              return de({ x: ne(e, 'x1'), y: ne(e, 'y1') }, { x: ne(e, 'x2'), y: ne(e, 'y2') });
            })(e);
          case 'polyline':
            return me(e);
          case 'polygon':
            return (function (e) {
              var t = e.points;
              return me(e) + de(t.getItem(t.numberOfItems - 1), t.getItem(0));
            })(e);
        }
      }
      function fe(e, t) {
      ...
      function ge(e, t) {
        var n = /[+-]?\d*\.?\d+(?:\.\d+)?(?:[eE][+-]?\d+)?/g,
          r = ue(R.pth(e) ? e.totalLength : e, t) + '';
        return {
          original: r,
      ...
      function Ne(e) {
        ...
        function p(e) {
          for (var t = 0, n = s.animations, r = n.length; t < r; ) {
            ...
            for (
              ...
              (b = c.isPath ? he(c.value, d * y, c.isPathTargetInsideSVG) : x + d * (y - x)),
        ...
        return (
          ...
          (s.play = function () {
            s.paused && (s.completed && s.reset(), (s.paused = !1), Le.push(s), d(), Ae());
          }),
          (s.reverse = function () {
              ...
              e &&
                e.map((e, n) => {
                  ...
                  const { frontmatter: i, html: o } = a,
                    { title: l, url: s, company: c, range: u, location: d } = i;
                  return r.createElement(
                    De.A,
      ...
      const Ct = c.default.ul.withConfig({
            ...
            r.createElement(
              ...
              e &&
                e.map((e, t) => {
                  let { node: a } = e;
                  const { frontmatter: i, html: o } = a,
                    { external: l, title: s, tech: c, github: u, cover: d } = i,
                    m = (0, dt.c)(d);
                  return r.createElement(
                    St,
                    ...
                    r.createElement(
                      ...
                      r.createElement(
                        'a',
                        { href: l || u || '#' },
                        r.createElement(dt.G, { image: m, alt: s, className: 'img' }),
                      ),
                    ),
                  );
                }),
      ...
      var Nt = () => {
        ...
        (0, r.useEffect)(() => {
          m ||
            ...
            mt.A.reveal(u.current, (0, Fe.srConfig)()),
            d.current.forEach((e, t) => mt.A.reveal(e, (0, Fe.srConfig)(100 * t))));
        }, []),
          (0, r.useEffect)(() => {
            const e = e => {
              'Escape' === e.key && p();
        ...
        return r.createElement(
          ...
          r.createElement(
            o.Link,
            { className: 'inline-link archive-link', to: '/archive', ref: u },
            'View Archive',
          ),
          r.createElement(
            'ul',
            ...
            m
              ? r.createElement(
                  ...
                  g &&
                    g.map((e, t) => {
                      let { node: n } = e;
                      return r.createElement(At, { key: t }, v(n));
                    }),
                )
              : r.createElement(
                  _e.A,
    ...
    7383: function (e, t, n) {
      ...
      function E(e) {
        ...
        if (g.generated || k.generated.initial) {
          ...
          g.generated &&
            S.fragments.push({
              delayed: 'opacity ' + L / 1e3 + 's ' + A + ' ' + T / 1e3 + 's',
              instant: 'opacity ' + L / 1e3 + 's ' + A + ' 0s',
            }),
            k.generated.initial &&
              S.fragments.push({
                delayed: k.property + ' ' + L / 1e3 + 's ' + A + ' ' + T / 1e3 + 's',
                instant: k.property + ' ' + L / 1e3 + 's ' + A + ' 0s',
              }),
            S.computed &&
      ...
      function ee(e) {
        ...
        return (!(K = t).mobile && L()) || (!K.desktop && !L())
          ? (y.call(
              this,
      ...
      var r,
        ...
        re = function (e, t) {
          var n = e.baseTag,
            ...
            d = e.title,
            m = e.titleAttributes;
          oe(y.BODY, r), oe(y.HTML, a), ie(d, m);
          var p = {
              baseTag: le(y.BASE, n),
        ...
        de = function (e) {
          ...
          return {
            ...
            script: ue(y.SCRIPT, s, r),
            style: ue(y.STYLE, c, r),
            title: ue(y.TITLE, { title: d, titleAttributes: m }, r),
          };
        },
        me = u()(
          function (e) {
            return {
              ...
              linkTags: Q(y.LINK, [A, E], e),
              metaTags: Q(y.META, [T, x, k, L, S], e),
              noscriptTags: Q(y.NOSCRIPT, [C], e),
              onChangeClientState: V(e),
              scriptTags: Q(y.SCRIPT, [j, C], e),
...
//# sourceMappingURL=546641dfde76ed00139ea2c3eae09499c5f2164a-03841c74007e89a10a28.js.map
