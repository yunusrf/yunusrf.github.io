        ...
        if (!t || !t.markdownRemark)
          return r.createElement(
            ...
            r.createElement(
              l,
              null,
              r.createElement('h1', null, 'Post Not Found'),
              r.createElement(
                'p',
                null,
                'The post you are looking for does not exist or was removed.',
              ),
              r.createElement(o.Link, { to: '/pensieve' }, 'Back to all memories'),
            ),
          );
        const { frontmatter: u, html: c } = t.markdownRemark,
          { title: m, date: p, tags: x } = u;
        return r.createElement(
          f.PE,
          { location: n },
          r.createElement(i.m, { title: m }),
          r.createElement(
            l,
            null,
            r.createElement(
...
//# sourceMappingURL=component---src-templates-post-js-478e59fe1581cca7a16f.js.map
